 ...
 */
class InMemoryByPageRepository(
        private val redditApi: Client,
        private val networkExecutor: Executor
) : PageRepository {

    override fun postsOfSubreddit(subReddit: String, pageSize: Int): DataSource.Factory<String, RedditPost> {
        return PageDataSourceFactory(redditApi, subReddit, networkExecutor)
    }
}
